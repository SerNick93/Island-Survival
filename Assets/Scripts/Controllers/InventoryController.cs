...
public class InventoryController : MonoBehaviour
{
    ...
    {
        string weightString = string.Format("{0} {1}{2}{3}", "Weight:", currentTotalCarryWeight.ToString(), "/", PlayerStats.MyInstance.CarryWeight.ToString());
    ...
    {
        if (currentTotalCarryWeight + item.ItemWeight > PlayerStats.MyInstance.CarryWeight)
        {
        ...
        else
        {
            foreach (ItemListing listing in itemListings)
            {
                ...
                {
                    currentTotalCarryWeight = currentTotalCarryWeight + item.ItemWeight;
                    WeightCheck();
